<form action={"rss2/edit_import"|ezurl} method="post" name="RSSImport">
...
<div class="context-attributes">
	...
	{* Language *}
	<div class="block">
	<label for="rssImportLanguage">{"Language"|i18n( 'design/admin/rss/edit_import' )}:</label>
	<select name="importLanguage">
		{foreach $languageAvailable as $lg}
	    		<option value="{$lg.locale}" {section show=$rss_import.language|eq( $lg.locale )}selected="selected"{/section}>{$lg.locale}</option>
	    {/foreach}
	</select>
	</div>
