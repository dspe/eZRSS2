...
class eZRSS2ExportItem extends eZPersistentObject
{
    ...
    */
    static function create( $rssexport_id )
    {
        $row = array( 'id' => null,
                      ...
                      'status' => 0,
                      'subnodes' => 0);
        return new eZRSS2ExportItem( $row );
    }
    ...
    */
    ...
    {
        return eZPersistentObject::fetchObject( eZRSS2ExportItem::definition(),
                                                null,
                                                array( "id" => $id,
                                                       'status' => $status ),
                                                $asObject );
    ...
    */
    static function fetchFilteredList( $cond, $asObject = true, $status = eZRSS2Export::STATUS_VALID )
    {
        return eZPersistentObject::fetchObjectList( eZRSS2ExportItem::definition(),
    ...
    */
    static function fetchNodeList( $rssSources, $objectListFilter, $language )
    {
